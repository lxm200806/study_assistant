    ...
    <view class="card">
      ...
      <view class="chips">
        <view
          ...
          @tap="toggleRequired(levels, item)"
        >
...
import { DIFFICULTY_OPTIONS, GRADE_OPTIONS, KIND_OPTIONS, LEVEL_OPTIONS, levelLabel } from '@/utils/chinese'
...
watch([kinds, grades, difficulties, levels, dailyMinutes], loadLibrary, { deep: true })
onMounted(async () => {
